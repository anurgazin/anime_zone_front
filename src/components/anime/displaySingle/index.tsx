...
export default function DisplaySingle({ anime, comments, rating, animeList, characters }: DisplaySingleProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-5 grid-rows-auto gap-4">
            {/* Top Banner */}
            <div className="lg:col-span-5 relative overflow-hidden -z-10 h-48 sm:h-56">
            ...
            <div className="lg:col-span-5 grid grid-cols-1 lg:grid-cols-6 lg:grid-rows-auto gap-5 justify-self-center px-4 sm:px-10 py-4">
                {/* Logo section */}
                <div className="flex justify-center lg:justify-start relative shadow-md bg-white w-full h-[350px]"
                ...
                {/* Data info */}
                <div className="lg:col-span-3 w-full lg:row-span-1 p-4 rounded-lg border-2 border-orange-200 lg:border-none">
                                ...
                                <div key={i} className="col-start-2">
                                    {isYouTubeLink ? (
                                        ...
                                        <div
                                            ...
                                            className='relative w-[320px] h-[170px]'>
                                            <Image
                                                src={mediaItem}
                                                fill
                                                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                                                className="rounded-md object-cover shadow-md border-2 border-orange-200 lg:hover:scale-[1.10] transition-scale duration-200"
                                                alt={`Media ${i}`}
                                            />
                                        </div>
                                    )}
                ...
                {/* Characters */}
                <div className="lg:col-span-6 lg:row-start-3 border-2 border-orange-200 p-6 rounded-lg shadow-md bg-white">
                ...
                {/* Reviews */}
                <div className="lg:col-span-6 lg:row-start-4 border-2 border-orange-200 shadow-md bg-white p-4 rounded-lg">
                ...
                <div className="lg:col-span-6 lg:row-start-5 grid grid-cols-1 lg:grid-cols-2 grid-rows-auto gap-2">
                    {/* Comments */}
